...
use Bank\LoanType\{ LoanTypeDto, LoanTypeModel, LoanTypeController };
...
class LoanTypeControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            ...
            "description" => "either",
            "base_amount" => 222.00,
            "base_interest_rate" => 782.60,
        ];
        $this->dto = new LoanTypeDto($this->input);
        $this->model = new LoanTypeModel($this->dto);
        $this->service = $this->createMock("Bank\LoanType\ILoanTypeService");
        $this->request = $this->createMock("Psr\Http\Message\ServerRequestInterface");
        $this->stream = $this->createMock("Psr\Http\Message\StreamInterface");
        $this->controller = new LoanTypeController(
            $this->service
        );
