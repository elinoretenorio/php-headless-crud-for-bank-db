...
use Bank\Card\{ CardDto, CardModel, ICardService, CardService };
...
class CardServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("Bank\Card\ICardRepository");
        $this->input = [
            "id" => 753,
            "number" => "them",
            "expiration_date" => "2021-10-01",
            "is_blocked" => "Loss time do free natural son nation.",
        ];
